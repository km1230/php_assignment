...
if($_SESSION['permission']<200 || preg_match('/2$/', $_SESSION['permission']) || preg_match('/3$/', $_SESSION['permission'])){
...
//GET	
//get order
$getOrder = "SELECT * FROM orders WHERE cafe='lazenbys' AND orderdate='".date('Y-m-d')."' ORDER BY collecttime";
...
//get item name
for($i = 0; $i < $numItem; $i++){
	$getItemName = "SELECT * FROM lazenbys WHERE ID='".$itemID[$i]."'";
...
<div id='carousel'>
	<img src='./img/coffee.jpg' alt='Lazenbys Order History'>
</div>

<!--Banner in middle-->
<div class='heading'>Lazenbys Orders History</div>
...
<div class='mb-3'>
	<ul class='breadcrumb'>
		...
		<li>
			<a href='./lazenbys_order.php'>::Lazenbys View Orders::</a>
		</li>
	</ul>
</div>
