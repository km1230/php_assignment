...
if($_SESSION['permission']<200 || preg_match('/1$/', $_SESSION['permission']) || preg_match('/2$/', $_SESSION['permission'])){
...
//GET	
//get order
$getOrder = "SELECT * FROM orders WHERE cafe='trade' AND orderdate='".date('Y-m-d')."' ORDER BY collecttime";
...
//get item name
for($i = 0; $i < $numItem; $i++){
	$getItemName = "SELECT * FROM trade WHERE ID='".$itemID[$i]."'";
...
<div id='carousel'>
	<img src='./img/wine.jpg' alt='Trade Table Order History'>
</div>

<!--Banner in middle-->
<div class='heading'>Trade Table Orders History</div>
...
<div class='mb-3'>
	<ul class='breadcrumb'>
		...
		<li>
			<a href='./trade_order.php'>::Trade Table View Orders::</a>
		</li>
	</ul>
</div>
